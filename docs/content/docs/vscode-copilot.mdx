...
Copilot API proxy endpoint, not the model: if the user selects GPT-4.1, Claude
Sonnet, Claude Opus, or another Copilot model, the same model ID travels through
Headroom to GitHub's Copilot API.
